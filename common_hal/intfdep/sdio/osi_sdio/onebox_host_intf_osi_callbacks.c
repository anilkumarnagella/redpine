...
static struct onebox_osi_host_intf_operations osi_host_intf_ops =
{
	.onebox_host_intf_read_pkt = host_intf_read_pkt,
	.onebox_host_intf_write_pkt = host_intf_write_pkt,
	.onebox_ack_interrupt = ack_interrupt,
	.onebox_disable_sdio_interrupt=disable_sdio_interrupt,
	.onebox_init_host_interface=init_host_interface,
...
{
	return &osi_host_intf_ops;
} 
EXPORT_SYMBOL(onebox_get_osi_host_intf_operations);
