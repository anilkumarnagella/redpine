...
#define ONEBOX_DESC_AGGR_ENAB_MASK 0x80
	...
	uint16         beacon_event; /* FIXME Should be made atomic later */
	uint16         beacon_event_vap_id; /* FIXME Should be made atomic later */
	uint32         bmiss_count;
	...
	struct onebox_bt_osd_operations    *bt_osd_ops;
...
#define SLEEP_ENTRY 1
	...
	int udp_pkts_dropped; //FIXME has to be removed = 0
	int pkts_dropped_max_queue_buffered; //FIXME has to be removed = 0
