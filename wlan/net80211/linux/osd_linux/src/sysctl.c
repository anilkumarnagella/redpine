 ...
 */
static ctl_table ieee80211_mesh_template[] = 
{
 ...
 */
static ctl_table ieee80211_hwmp_template[] = 
{
#if KERNEL_VERSION_BTWN_2_6_(18,30)
	{
		.ctl_name     = CTL_AUTO,
 ...
 */
static ctl_table ieee80211_parent_sysctl_template[] = 
{
#if KERNEL_VERSION_BTWN_2_6_(18,30)
	{
		.ctl_name       = CTL_AUTO,
 ...
 * List of generic 802.11 variables exported to the user via sysctl
 */
static ctl_table ieee80211_sysctl_template[] = 
{
#if KERNEL_VERSION_BTWN_2_6_(18,30)
	{ 
		.ctl_name     = CTL_AUTO,
